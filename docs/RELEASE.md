...
2. Linux quality checks verify formatting, TypeScript declarations, independent tarball installation, documentation build and 160 language/theme/viewport/route cases plus interactions.
