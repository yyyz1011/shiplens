...
2. Linux quality checks verify formatting, TypeScript declarations, independent tarball installation, real documentation-app plan verification, documentation build and 176 language/theme/viewport/route cases plus interactions.
