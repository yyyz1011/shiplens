...
2. Linux quality checks verify formatting, TypeScript declarations, independent tarball installation, documentation build and 128 language/theme/viewport/route cases plus interactions.
