...
The documentation includes English/Chinese and light/dark controls, defaults to English, and remembers preferences. To check it, serve the production build on port 4318 and run `npm run test:ui`. See [release operations](https://github.com/yyyz1011/shiplens/blob/master/docs/RELEASE.md) and [QA scope](https://github.com/yyyz1011/shiplens/blob/master/docs/QA.md).
